/**
 * Entitas-ECS definitions for matchone
 */
...
declare module entitas {
    ...
    class GameBoardCacheComponent implements IComponent {
      public grid:Array<Array<Entity>>;
    }
    class GameBoardComponent implements IComponent {
      public columns:number;
      public rows:number;
    }
    class GameBoardElementComponent implements IComponent {
    }
...
/** Matcher Extensions for matchone */
        ...
        static _matcherGameBoardCache;
        static GameBoardCache: Matcher;
        static _matcherGameBoard;
        static GameBoard: Matcher;
        static _matcherGameBoardElement;
        static GameBoardElement: Matcher;
...
declare module entitas {
    ...
    class Entity {
/** Entity Extensions for matchone */
        ...
        static _gameBoardCacheComponentPool;
        static clearGameBoardCacheComponentPool();
        gameBoardCache: GameBoardCacheComponent;
        hasGameBoardCache: boolean;
        addGameBoardCache(grid:Array<Array<Entity>>);
        replaceGameBoardCache(grid:Array<Array<Entity>>);
        removeGameBoardCache();
        static _gameBoardComponentPool;
        static clearGameBoardComponentPool();
        gameBoard: GameBoardComponent;
        hasGameBoard: boolean;
        addGameBoard(columns:number, rows:number);
        replaceGameBoard(columns:number, rows:number);
        removeGameBoard();
        static gameBoardElementComponent: GameBoardElementComponent;
        isGameBoardElement: boolean;
        setGameBoardElement(value: boolean);
...
declare module entitas {
     ...
     */
    class Pool {
/*** Extensions for matchone.Pool */
        createRandomPiece(x:number, y:number):Entity;
        createBlocker(x:number, y:number):Entity;
/** Pool Extensions for matchone */
        gameBoardCacheEntity: Entity;
        gameBoardCache: GameBoardCacheComponent;
        hasGameBoardCache: boolean;
        setGameBoardCache(grid:Array<Array<Entity>>): Entity;
        replaceGameBoardCache(grid:Array<Array<Entity>>): Entity;
        removeGameBoardCache(): void;
        gameBoardEntity: Entity;
        gameBoard: GameBoardComponent;
        hasGameBoard: boolean;
        setGameBoard(columns:number, rows:number): Entity;
        replaceGameBoard(columns:number, rows:number): Entity;
        removeGameBoard(): void;
        scoreEntity: Entity;
        score: ScoreComponent;
        hasScore: boolean;
